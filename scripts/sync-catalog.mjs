 ...
 *
 * Uso:
 *   REDALIA_SYNC_SECRET=... node scripts/sync-catalog.mjs
...
const secret = (process.env.REDALIA_SYNC_SECRET || process.env.REDALIA_HEALTH_SECRET || "").trim();

if (!secret) {
  console.error("Falta REDALIA_SYNC_SECRET (o REDALIA_HEALTH_SECRET) para ejecutar sync protegido.");
  process.exit(1);
}
